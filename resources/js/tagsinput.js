var Tagsinput = {
    ...
    init: function (maindiv, options) {
        ...
        if (this.taglist.prop('tagName') != 'UL')
            throw 'not a UL';
    ...
    hasValue: function (data) {
        if (this.options.checkunicity) {
            ...
            return this.taglist.children().filter(function (idx, elt) {
                return jQuery(elt).children('span').data('tagdata')[field] == valtocheck
            }).length > 0;
        } else {
            return false;
        }
